    ...
    Env Manager Hyhyfj
    ==================
    A fast CLI utility to validate files and directories straight from the terminal.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="A fast CLI utility to validate files and directories straight from the terminal.")
